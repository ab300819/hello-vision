//
// Created by mason on 2019/12/30.
//
...
int main(int, char *[]) {
...

    {
        ...
        std::cout << "Dist0:" << dist0 << " closet point:" << closest[0] << " " << closest[1] << " " << closest[2]
                  << std::endl;

        double dist1 = vtkLine::DistanceToLine(p1, lineP0, lineP1, t, closest);
        std::cout << "Dist1:" << dist1 << " closet point:" << closest[0] << " " << closest[1] << " " << closest[2]
                  << std::endl;
    }
